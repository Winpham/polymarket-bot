...
pub async fn consensus_cycle(
    ...
    // At-fire ask capture budget (migration 042). Only NEWLY-INSERTED signals are
    ...
    for sig in &signals {
        ...
        // --- AT-FIRE executable-ask capture (mig 042, flag CAPTURE_ENTRY_ASK_AT_FIRE,
...
/// Capture the executable ask AT FIRE for a just-inserted signal (migration 042).
///

...
| 2026-06-28 | [07 — Data readiness](entries/2026-06-28-07-data-readiness.md) | Robust CLOB result capture (sports incl.); position trajectory ('works like a stock'); belief-blind promotion gate (cluster-robust surplus, distinct-event floor) — all verified |
